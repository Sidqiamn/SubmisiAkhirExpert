  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `news` (`title` TEXT NOT NULL, `summary` TEXT NOT NULL, `penyelenggara` TEXT NOT NULL, `time` TEXT NOT NULL, `quota` INTEGER NOT NULL, `link` TEXT NOT NULL, `deskripsi` TEXT NOT NULL, `publishedAt` TEXT NOT NULL, `urlToImage` TEXT, `url` TEXT, `bookmarked` INTEGER NOT NULL, PRIMARY KEY(`title`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '996ddbf8cee69961f9c073aeb3e28f1b')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsNews.put("summary", new TableInfo.Column("summary", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNews.put("penyelenggara", new TableInfo.Column("penyelenggara", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNews.put("time", new TableInfo.Column("time", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNews.put("quota", new TableInfo.Column("quota", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNews.put("link", new TableInfo.Column("link", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsNews.put("deskripsi", new TableInfo.Column("deskripsi", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsNews.put("bookmarked", new TableInfo.Column("bookmarked", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoNews.equals(_existingNews)) {
          return new RoomOpenHelper.ValidationResult(false, "news(com.example.core.data.NewsEntity).\n"
                  + " Expected:\n" + _infoNews + "\n"
                  + " Found:\n" + _existingNews);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "996ddbf8cee69961f9c073aeb3e28f1b", "430daf02ca062a7366eca40fe2296ccb");
